...
<recipetype:tconstruct:casting_basin>.addItemCastingRecipe("steel_casing", <item:thermal:machine_frame>, <fluid:tconstruct:molten_steel> * 576, <item:mekanism:steel_casing>, 10000, true, true);
...
<recipetype:tconstruct:casting_basin>.addItemCastingRecipe("compact_wall", <item:minecraft:redstone_block>, <fluid:tconstruct:molten_iron> * 1296, <item:compactmachines:wall>, 10000, true, true);

<recipetype:tconstruct:casting_basin>.addItemCastingRecipe("rf_coil", <item:silents_mechanisms:redstone_alloy_ingot>, <fluid:tconstruct:molten_gold> * 144, <item:thermal:rf_coil>, 10000, true, true);

<recipetype:thermal:crucible>.addRecipe("molten_gold", <fluid:tconstruct:molten_gold> *144, <item:minecraft:gold_ingot>, 50000);

craftingTable.removeRecipe(<item:thermal:rf_coil>);
<recipetype:thermal:bottler>.addRecipe("rf_coil", <item:thermal:rf_coil>, <item:silents_mechanisms:redstone_alloy_ingot>, <fluid:tconstruct:molten_gold> *144, 50000);
